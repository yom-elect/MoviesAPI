    ...
    public class AutoMapperProfiles : Profile
    {
        public AutoMapperProfiles()
        {
            ...
            CreateMap<Movie, MovieDetailsDTO>()
               .ForMember(x => x.Poster, options => options.Ignore())
               .ForMember(x => x.Genres, options => options.MapFrom(MapGenres))
        ...
        private List<GenreDTO> MapGenres( Movie movie, MovieDetailsDTO movieDetailsDTO)
        {
        ...
        private List<ActorDTO> MapActors(Movie movie, MovieDetailsDTO movieDetailsDTO)
        {
